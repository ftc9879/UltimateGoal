...
public class OutsideAutoOdometry extends LinearOpMode {
        ...
        if (guess == 0) {
         ...
         // If the vision detected 2 then it runs this sequence
            ...
            if (guess == 0) {
                ...
                // Strafes along the launch line to the middle of the field
                strafe('l', 5500, .75, -90);
                moveStraight('b',12000,-90,0.9);
                waiting(.25);
                pointTurn('l',5,0.4);
                waiting(1); //12
                moveStraight('b',6000,0,0.9);
                waiting(1);
            }
