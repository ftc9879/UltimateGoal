...
@Autonomous
public class HighGoalNoStack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (guess == 2) {
            moveStraight('f',2870,0,0.6);
            strafe('r', 1700, 0.5, 0.0);
            strafe('l', 200, 0.5, 0.0);
            SideServo2.setPosition(0);

            strafe('l', 2100, 0.5, 0.0);
            moveStraight('b',-2000,0,0.6);
        }
        if (guess == 1) {
            // Place the wobble goal
            moveStraight('f',1940,0,0.5);
            SideServo2.setPosition(0);
            strafe('l', 612, 0.5, 0.0);
            moveStraight('b', -1350, 0.0, 0.6);
        }
        if (guess == 0) {
            // Sweep the field for extra rings
            moveStraight('f', 600, 0.0, 0.6);
            strafe('r', 1700, 0.5, 0.0);
            strafe('l', 200, 0.5, 0.0);
            SideServo2.setPosition(0);

            // Park on the line
            strafe('l', 2300, 0.5, 0.0);
        }
