...
public class OutsideAutoOdometryBlue extends LinearOpMode {
    ...
    public OutsideAutoOdometryBlue() {
        straightP = 0.075;
        visionReadTime = 0.1;
        currentCounts = 0;
        lastCounts = 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (guess == 0) {
            ...
            pointTurn('l',85,.4);
            moveStraight('f',400,90,0.6);
            strafe('r', 5800, 0.5, 90.0);
            SideServo.setPosition(1.0);
        }
         // If the vision detected 2 then it runs this sequence
            if (guess == 2) {
               ...
               strafe('r',5650,.8,0); // 12650
                waiting(1);
                moveStraight('b', 12200, 0.0, 0.9);
                waiting(1);
            }
          ...
          //      strafe('r', 3600, 0.75, 0); // 3600
                waiting(1);
                moveStraight('b',4600,0,0.9);
                waiting(1);
            }
            // If the vision detected 0 then it runs this sequence
            if (guess == 0) {
                ...
                // Strafes along the launch line to the middle of the field
                strafe('r', 2500, .75, 90); // 5500
                moveStraight('b',10000,90,0.9);
                waiting(.25);
                pointTurn('r',5,0.4);
                waiting(1); //12
                moveStraight('b',5000,0,0.9);
                waiting(1);
            }
