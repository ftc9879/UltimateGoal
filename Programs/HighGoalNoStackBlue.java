...
@Autonomous
public class HighGoalNoStackBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (guess == 2) {
            ...
            strafe('l', 1500, 0.5, 0.0);
            strafe('r', 200, 0.5, 0.0);
            SideServo.setPosition(1);

            strafe('r', 1900, 0.5, 0.0);
            moveStraight('b',-2400,0,0.6);
        }
        if (guess == 1) {
            // Place the wobble goal
            moveStraight('f',1640,0,0.5);
            SideServo.setPosition(1);
            strafe('r', 612, 0.5, 0.0);
            moveStraight('b', -1200, 0.0, 0.6);
        }
        if (guess == 0) {
            // Sweep the field for extra rings
            moveStraight('f', 328, 0.0, 0.6);
            strafe('l', 1500, 0.5, 0.0);
            strafe('r', 200, 0.5, 0.0);
            SideServo.setPosition(1);
