...
public class PowerShotAutoOdoNoStackBlue extends LinearOpMode {
    ...
    public PowerShotAutoOdoNoStackBlue() {
        straightP = 0.075;
        visionReadTime = 0.1;
        currentCounts = 0;
        lastCounts = 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (guess == 2) {
            ...
            strafe('l', 15000, 0.75, 0.0);
            strafe('r', 1175, 0.75, 0.0);
            SideServo.setPosition(1);

            strafe('r', 11000, 0.75, 0.0);
            moveStraight('b',13500,0,0.6);
        }
        if (guess == 1) {
            // Place the wobble goal
            moveStraight('f',10000,0,0.5);
            strafe('l', 5000, 0.75, 0.0);
            SideServo.setPosition(1);
            strafe('r', 2600, 0.75, 0.0);
            moveStraight('b', 6000, 0.0, 0.6);
        }
        if (guess == 0) {
