...
public class HighGoalAutoOdometryBlue extends LinearOpMode {
    ...
    public HighGoalAutoOdometryBlue() {
        straightP = 0.075;
        visionReadTime = 0.1;
        currentCounts = 0;
        lastCounts = 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (guess > 0) {
            ...
            waiting(9.5); // normal: 9.5 8373: 9.5 92: 7 
            strafe('l', 5375, 0.5, 0);
            IntakeServo.setPower(1.0);
            IntakeServo2.setPower(-1.0);
            IntakeMotor.setPower(-1.0);
        ...
        if (guess == 2) {
            ...
            moveStraight('f', 16720, 0.0, 0.9);
            strafe('l', 3245, 0.5, 0.0);
        ...
        if (guess == 1) {
            ...
            // Park on the line
            strafe('r', 2820, 0.5, -90);
            pointTurn('l', -5, 0.4);
        }
        if (guess == 0) {
            // Sweep the field for extra rings
            moveStraight('f', 23035, 0.0, 0.9);
            waiting(.5);
            ...
            strafe('l', 4425, 0.5, 0.0);
            strafe('r', 1175, 0.5, 0.0);
            SideServo.setPosition(1.0);

            // Park on the line
            strafe('r', 2350, 0.5, 0.0);
        }
